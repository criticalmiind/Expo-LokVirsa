...
const CustomDrawerComponent = (Props, state=states) => (
  <SafeAreaView style={style.mainContainer}>
    ...
    <ScrollView style={{backgroundColor: "#FFF6CA" }}>
      {/* <DrawerItems {...Props} /> */}
      ...
      <View style={style.release}>
        <Text style={{ fontSize:10, color:'gray' }}>Release: 07:10 AM</Text>
        <Text style={{ fontSize:10, color:'gray' }}>Saturday, 20 June 2020</Text>
      </View>
    </ScrollView>
